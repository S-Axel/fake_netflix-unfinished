...
# from https://www.mongodb.com/community/forums/t/cant-resolve-crypto-in-node-modules-bson-dist-react/143227
...
echo "Done! realm-web crypto dependency fixed. You can now run 'yarn build' without warnings :)"
